...
<?php endforeach; endif; ?>
                            ...
                            <div class="leftlabel"><label>Your Name: </label></div>
                            	<div class="rightform"><input type="text" name="name" id="name" value="<?=$name;?>" <?php if(is_array($errors)){if($name == ''){?>style="border:1px solid #F00;"<?php }}?> ></div>
                            <div class="leftlabel"><label>Contact Number: </label></div>
                            	<div class="rightform"><input type="text" name="contact" id="name" value="<?=$contact;?>" <?php if(is_array($errors)){if($contact == ''){?>style="border:1px solid #F00;"<?php }}?> ></div>
                            <div class="leftlabel"><label>E-mail Address: </label></div>
                            	<div class="rightform"><input type="text" name="email" id="email" value="<?=$email;?>" <?php if(is_array($errors)){if($email == ''){?>style="border:1px solid #F00;"<?php }}?> ></div>
                            <div class="leftlabel"><label>Message: </label></div>
                            	<div class="rightform">
                                	<textarea name="message" id="message" rows="4" <?php if(is_array($errors)){if($messages == ''){?>style="border:1px solid #F00;"<?php }}?> ><?=$messages;?></textarea>
                                </div> 
                        </li>
                        <li>
